...
class QtDBConsoleWindow(QMainWindow):
    ...
    def sendPackage(self):
        ...
        self.sendPackageTab.layout.addWidget(
            self.SPCommentLabel, 4, 0, 1, 4, Qt.AlignLeft
        )
    ...
    def submitSPRequest(self):
        ...
        for arg in Args:
            ...
            if arg == "date_sent":
                Data.append(
                    self.SPDateSentEdit.dateTime()
                    .toUTC()
                    .toString("yyyy-dd-MM hh:mm:ss.z")
                )
                SubmitArgs.append(arg)
            if arg == "carrier":
    ...
    def receivePackage(self):
        ...
        self.receivePackageTab.layout.addWidget(
            receivePackageLabel, 0, 0, 1, 4, Qt.AlignTop
        )
        ...
        self.receivePackageTab.layout.addWidget(
            self.RPCommentLabel, 6, 0, 1, 4, Qt.AlignLeft
        )
    ...
    def submitRPRequest(self):
        ...
        for arg in Args:
            ...
            if arg == "date_received":
                Data.append(
                    self.RPDateReceivedEdit.dateTime()
                    .toUTC()
                    .toString("yyyy-dd-MM hh:mm:ss.z")
                )
                SubmitArgs.append(arg)
    ...
    def displayUsers(self):
        ...
        dataList = [describeTable(self.connection, "people")] + retrieveGenericTable(
            self.connection, "people"
        )
    ...
    def submitAURequest(self):
        ...
        if (
            self.AUNewUsernameEdit.text() == ""
            or self.AUNameEdit.text() == ""
        ...
        try:
            ...
            InstName = getByColumnName(
                "institute", describeTable(self.connection, "institute"), InstituteInfo
            )
    ...
    def displayInstitue(self):
        ...
        dataList = [describeInstitute(self.connection)] + retrieveAllInstitute(
            self.connection
        )
    ...
    def fileComplaint(self):
        ...
        UserInfo = retrieveWithConstraint(
            self.connection, "people", username=self.TryUsername
        )
        ...
        self.ComplaintTab.layout.addWidget(
            self.FCCommentLabel, 2, 0, 1, 4, Qt.AlignLeft
        )
    ...
    def submitFCRequest(self):
        ...
        Data = []
        Data.append(
            self.FCDateTimeEdit.dateTime().toUTC().toString("yyyy-dd-MM hh:mm:ss.z")
        )
    ...
    def connectedHeadLine(self):
        ...
        DBStatusLabel.setText(
            "Database:{}/{}".format(self.TryHostAddress, self.TryDatabase)
        )
