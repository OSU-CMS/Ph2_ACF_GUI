...
class SummaryBox(QWidget):
    ...
    def checkFwPar(pfirmwareName, module_type, fc7_ip):
        ...
        try:
            ...
            logger.info("updated the uri value")
            ...
            if FWisPresent:
                ...
                logger.info("Firmware image is now loaded")
        ...
        if self.runFlag:
            ...
            if reply == QMessageBox.Yes:
                ...
                try:
                    ...
                    logger.warning(
                        "Warning: Incident detected while trying to turn off power supply, please check power status"
                    )
                    logger.error(traceback.format_exc())
            else:
                event.ignore()
