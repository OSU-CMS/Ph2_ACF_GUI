...
from Gui.Config.siteConfig import *

# from icicle.icicle.keysightE3633A import KeysightE3633A
from icicle.icicle.keithley2410 import Keithley2410
...
class PowerSupply:
    ...
    def setPortAddress(self, resourceName):
        try:
            print(resourceName)
            self.setResourceManager()
...
if __name__ == "__main__":
    ...
    LVpowersupply.setPortAddress("ASRL/dev/ttyUSBLV::INSTR")
