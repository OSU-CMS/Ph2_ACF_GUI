...
class ArgvParser
{
  public:
     ...
     * action is peformed.
     */
    bool defineOption(const std::string& _name, const std::string& _description = std::string(), OptionAttributes _attributes = NoOptionAttribute);
     ...
     */
    bool defineOptionAlternative(const std::string& _original, const std::string& _alternative);
     ...
     */
    bool setHelpOption(const std::string& _longname = "h", const std::string& _shortname = "help", const std::string& _descr = "");
 ...
 */
bool splitOptionAndValue(const std::string& _string, std::string& _option, std::string& _value);
...
void splitString(Container& _container, const std::string& _in, const char* const _delimiters = " \t\n")
{
 ...
 */
bool expandRangeStringToUInt(const std::string& _string, std::vector<unsigned int>& _expanded);
 ...
 */
std::string formatString(const std::string& _string, unsigned int _width, unsigned int _indent = 0);
