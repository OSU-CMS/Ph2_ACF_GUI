...
@Instrument.register
class Keithley6500(SCPIInstrument, key="resource"):
    ...
    def __enter__(self, recover_attempt=False):
        """Initialises connection to Keithley 6500.

        :param recovery_attempt: Whether this is a recovery attempt by retry_on_fail.

        :return: `Keithley6500` object in activated state.
        """
    ...
    def __exit__(
        ...
        """Closes connection to Keithley 6500.
...
Keithley6500.SETTINGS["MEASUREMENT_EVENT_REGISTER"] = Keithley6500.SETTINGS[
    "QUESTIONABLE_DATA_REGISTER_ENABLE"
]
Keithley6500.SETTINGS["MEASUREMENT_REGISTER"] = Keithley6500.SETTINGS[
    "QUESTIONABLE_DATA_REGISTER"
]
Keithley6500.SETTINGS["SERVICE_REQUEST_ENABLE"] = Keithley6500.SETTINGS[
    "STATUS_BYTE_ENABLE"
]
Keithley6500.SETTINGS["SENSE_AVERAGING"] = Keithley6500.SETTINGS["ENABLE_AVERAGING"]
Keithley6500.SETTINGS["SENSE_AVERAGING_COUNT"] = Keithley6500.SETTINGS[
    "AVERAGING_COUNT"
]
Keithley6500.SETTINGS["SENSE_AVERAGING_TYPE"] = Keithley6500.SETTINGS[
    "AVERAGING_FUNCTION"
]
Keithley6500.SETTINGS["AUTODELAY_SWITCH"] = Keithley6500.SETTINGS["TRIGGER_DELAY_AUTO"]
Keithley6500.SETTINGS["DELAY"] = Keithley6500.SETTINGS["TRIGGER_DELAY"]
Keithley6500.SETTINGS.update(
    {
