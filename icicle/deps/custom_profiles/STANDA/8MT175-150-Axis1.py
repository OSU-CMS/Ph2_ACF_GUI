...
def set_profile_8MT175_150(lib, id):
    ...
    controller_name.ControllerName = 'AxisX'.encode()
    class CtrlFlags_:
        EEPROM_PRECEDENCE = 1
    ...
    stage_information.Manufacturer = 'STANDA'.encode()
    stage_information.PartNumber = '8MT175-150'.encode()
    ...
    motor_information.Manufacturer = 'MOTION CONTROL'.encode()
