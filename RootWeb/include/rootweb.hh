...
#define DEFAULTPROGRAMNAME "noName"
#define DEFAULTPROGRAMSITE "https://github.com/xxx/xxx"
...
class RootWFileList : public RootWItem
{
  ...
  public:
    ...
    template <class I>
    RootWFileList(I begin, I end, const string& description) : description_(description)
    {
        addFileNames(begin, end);
    }
    void addFileName(string newFileName) { fileNames_.push_back(newFileName); }
    template <class I>
    void addFileNames(I begin, I end)
    {
...
class RootWBinaryFileList : public RootWFileList
{
  ...
  public:
    ...
    template <class I>
    RootWBinaryFileList(I begin, I end, string newDescription) : RootWFileList(begin, end, newDescription)
    {
    }
    template <class I, class J>
    RootWBinaryFileList(I beginDestNames, I endDestNames, string newDescription, J beginOrigNames, J endOrigNames) : RootWFileList(beginDestNames, endDestNames, newDescription)
    {
        setOriginalFiles(beginOrigNames, endOrigNames);
    }
    template <class I>
    void setOriginalFiles(I begin, I end)
    {
...
class RootWSite
{
  ...
  public:
    ...
    void   setProgram(const std::string&, const std::string&);
};
