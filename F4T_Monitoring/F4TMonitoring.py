...
class F4TMonitor():
    ...
    def updateData(self):
        while True:
            ...
            if len(self.datalogs)>15 or (self.dangerZoneQ(self.datalogs) and time.time() - self.lastEmailTime > self.timeBetweenEmails) or (self.developmentMode and len(datalogs)>0):
